...
OMP_NUM_THREADS=8 \\
python train_l2_astronomy_model.py \\
    --data_root \"$DATA_ROOT\" \\
    --max_steps 100000 \\
    --batch_size 6 \\
...
print(\"  2. MIXED PRECISION: DISABLED in Phase 1 (same as Poisson)\")
print(\"  3. DATA LOADING: Conservative workers (identical setup)\")
print(\"  4. DATASET: Same single-channel grayscale astronomy data\")
...
print(\"  8. VALIDATION: Every 2 epochs (identical monitoring)\")
print(\"  9. GRADIENT CLIPPING: 0.1 (identical to Poisson)\")
print(\" 10. LEARNING RATE: 2e-5 → 1e-5 (identical phasing)\")
...
echo "  • Learning Rate: 2e-5 (identical to Poisson)"
