...
def main():
    ...
    # Adaptive kappa parameters
    parser.add_argument("--use_adaptive_kappa", action="store_true",
    ...
    parser.add_argument("--max_kappa", type=float, default=2.0,
                       help="Maximum kappa value for high signal regions")
    parser.add_argument("--signal_threshold", type=float, default=50.0,
