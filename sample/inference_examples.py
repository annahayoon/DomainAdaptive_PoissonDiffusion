...
def main():
    ...
    sony_cmd = base_args + [
        "--output_dir",
        "results/inference_sony_optimized",
        "--sensor_filter",
        "sony",
        "--cross_domain_kappa",
        "0.7",
    ...
    fuji_cmd = base_args + [
        "--output_dir",
        "results/inference_fuji_optimized",
        "--sensor_filter",
        "fuji",
        "--cross_domain_kappa",
        "0.6",
    ...
    mixed_cmd = base_args + [
        "--output_dir",
        "results/inference_mixed_default",
        "--cross_domain_kappa",
        "0.7",
        "--cross_domain_sigma_r",
        "3.0",
    ...
    sony_single_cmd = base_args + [
        "--output_dir",
        "results/inference_sony_single_domain",
        "--sensor_filter",
        "sony",
        "--num_steps",
        "18",
    ...
    fuji_single_cmd = base_args + [
        "--output_dir",
        "results/inference_fuji_single_domain",
        "--sensor_filter",
        "fuji",
        "--num_steps",
        "18",
