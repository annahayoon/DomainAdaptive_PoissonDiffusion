...
def test_adaptive_kappa_on_sample_tiles():
    ...
    results_dir = Path("/home/jilab/Jae/results/optimized_inference_all_tiles/photography_fuji_optimized")
    ...
    with open('/home/jilab/Jae/dataset/processed/metadata_photography_incremental.json', 'r') as f:
    ...
    for sample_dir in sample_dirs:
        tile_id = sample_dir.name.replace('example_', '').replace('_photography_fuji', '')
