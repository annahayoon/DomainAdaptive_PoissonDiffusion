...
# Configuration
DATA_ROOT="${DATA_ROOT:-/home/jilab/Jae/dataset/processed/pt_tiles/astronomy_v2/clean}"
METADATA_JSON="${METADATA_JSON:-/home/jilab/Jae/dataset/processed/pt_tiles/astronomy_v2/metadata_astronomy_incremental.json}"
...
IMG_RESOLUTION=256
CHANNELS=1              # 1 for grayscale astronomy data
...
python3 train/train_pt_edm_native_astronomy.py \
    --data_root "$DATA_ROOT" \
