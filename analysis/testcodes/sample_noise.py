...
Usage:
    python sample_noise.py \
        ...
        --output_dir results/edm_noise_sampling_sony\
        --num_steps 18 \
        --domain sony \
        --num_samples 4
        --batch_size 4
...
project_root = Path(
    __file__
).parent.parent.parent  # Go up from testcodes/analysis/ to project root
...
class ComprehensiveEDMSampler:
    ...
    def __init__(
        ...
        """Initialize the sampler with trained model and sensor configurations."""
    ...
    def denormalize_to_physical(self, tensor: torch.Tensor, sensor: str) -> np.ndarray:
        ...
        Args:
            ...
            sensor: Sensor name (sony, fuji) for range lookup
...
def main():
    ...
    parser.add_argument(
        ...
        default="sony",
        choices=["sony", "fuji"],
        help="Sensor name (sony or fuji) for conditioning and normalization",
    )
    ...
    # Create domain labels using centralized utility
    ...
    save_json_safe(metadata, metadata_path)
